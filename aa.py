...
class UIManager:
    ...
    def add_worker_window(self):
        ...
        male_rb = tk.Radiobutton(add_window, text="Erkək", variable=gender_var, value="Erkək", font=("Arial", 12),
                                 bg=BG_COLOR, fg=FG_COLOR)
        male_rb.pack(anchor="w")

        female_rb = tk.Radiobutton(add_window, text="Qadın", variable=gender_var, value="Qadın", font=("Arial", 12),
                                   bg=BG_COLOR, fg=FG_COLOR)
    ...
    def edit_worker_window(self, worker):
        ...
        male_rb = tk.Radiobutton(edit_window, text="Erkək", variable=gender_var, value="Erkək", font=("Arial", 12),
                                 bg=BG_COLOR, fg=FG_COLOR)
        male_rb.pack(anchor="w")

        female_rb = tk.Radiobutton(edit_window, text="Qadın", variable=gender_var, value="Qadın", font=("Arial", 12),
                                   bg=BG_COLOR, fg=FG_COLOR)
        female_rb.pack(anchor="w")
