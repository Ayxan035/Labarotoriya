...
class UIManager:
    def __init__(self, root, manager):
        ...
        list_button = tk.Button(self.root, text="Butun Ishcileri Goster", command=self.list_workers_window,
    ...
    def show_worker_details_window(self, worker):
        ...
        tk.Label(details_window, text="Ishchi Haqqinda Melumat", font=("Arial", 14, "bold"), bg=BG_COLOR,
        ...
        edit_button = tk.Button(details_window, text="Edit Et", command=lambda: self.edit_worker_window(worker),
    ...
    def edit_worker_window(self, worker):
        ...
        experience_combobox = self.create_combobox(edit_window, "Ish Tecrubesi:", ["1 il;", "1-3 il", "3 Ilden Chox"])
        ...
        save_button = tk.Button(edit_window, text="Deyishiklikleri Saxla", command=save_edits, font=("Arial", 12),
                                bg=BUTTON_BG, fg=BUTTON_FG)
        save_button.pack(pady=20)
